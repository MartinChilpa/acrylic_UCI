...
def contract_request_signature(artist):
    ...
    document_name = (
        'Master Recording and Compositions Synchronization '
        'Representation Agreement'
    )

    # Generate PDF
    html_string = render_to_string(
        'legal/artist_contract_pdf.html',
        {'artist': artist}
    )
    ...
    pdf_file = weasyprint.HTML(
        ...
        stylesheets=[
            weasyprint.CSS(finders.find('css/pdf_legal.css'))
        ]
    )
    ...
    message = (
        f'Please sign the Acrylic.la {document_name}.\n\n'
        'Best,\n'
        'Acrylic.LA'
    )
    ...
    response = signwell.request_signatures(
        documents=documents,
        emails=emails,
        subject=subject,
        message=message
...
def splitsheet_request_signatures(split_sheet):
    ...
    message = (
        f'Please sign the split sheet of the track with ISRC {split_sheet.isrc}.\n\n'
        'Best,\n'
        'Acrylic.LA'
    )
